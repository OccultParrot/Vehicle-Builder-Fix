...
class Cli {
  // [DONE] TODO: You will need to use the Union operator to define additional types for the array
  // [DONE] TODO: See the AbleToTow interface for an example of how to use the Union operator
